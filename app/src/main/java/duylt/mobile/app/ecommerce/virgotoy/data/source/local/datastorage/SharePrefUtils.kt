package duylt.mobile.app.ecommerce.virgotoy.data.source.local.datastorage
...
object SharePrefUtils {
    ...
    var jsonAccountCurrent: String
        get() = getValue("account_current", "")
        set(value) = setValue("account_current", value)
}